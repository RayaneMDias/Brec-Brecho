...
<%-- 
  Segurança: O Servlet já protegeu esta página.
  Pegamos os dados que o 'MeusPedidosServlet' enviou.
--%>
...
<head>
    ...
    <style>
        ...
        .folha-recibo {
            ...
            width: 700px; /* Largura mais comum para recibos */
            min-height: 800px;
            margin: 0 auto;
            padding: 40px;
        ...
        .tabela-itens .col-valor { text-align: right; width: 120px; }
        ...
        .resumo-total {
            ...
            width: 40%;
            margin-left: 60%; /* Alinha à direita */
            font-size: 1.1rem;
        }
        .resumo-total table { width: 100%; }
        .resumo-total td { padding: 5px; }
    ...
    <div class="folha-recibo">
        ...
        <div class="header-recibo">
            ...
            <div class="info-pedido">
                ...
                Data: <fmt:formatDate value="${pedido.dataPedido}" pattern="dd/MM/yyyy" />
            </div>
        </div>
            ...
            <tbody>
                ...
                <c:forEach var="item" items="${pedido.itens}">
                    <tr>
                        ...
                        <td class="col-valor">
                            <fmt:formatNumber value="${item.precoUnitarioVenda * item.quantidade}" type="currency"/>
                        </td>
                    </tr>
                    <c:set var="subtotalItens" value="${subtotalItens + (item.quantidade * item.precoUnitarioVenda)}" />
                </c:forEach>
            </tbody>
        </table>
        ...
        <div class="resumo-total">
            <table>
                <tr>
                    ...
                    <td class="col-valor"><fmt:formatNumber value="${subtotalItens}" type="currency"/></td>
                </tr>
                <tr>
                    <td>Frete:</td>
                    <td class="col-valor"><fmt:formatNumber value="15.00" type="currency"/></td>
                </tr>
                <tr>
                    <td class="total-final">Valor Total:</td>
                    <td class="col-valor total-final">
