    ...
    <main>
        ...
        <form id="form-perfil" class="formulario" action="salvarPerfil" method="POST">
            ...
            <c:if test="${param.msg == 'sucesso'}">
                <p class="feedback-msg feedback-sucesso">Perfil atualizado com sucesso!</p>
            </c:if>
            <c:if test="${param.msg == 'erro_atualizar' || param.msg == 'erro_excecao'}">
                <p class="feedback-msg feedback-erro">Erro ao atualizar o perfil. Tente novamente.</p>
            </c:if>
            ...
            <button type="submit" class="btn-principal btn-full-width" ${isFormDisabled}>Salvar Alterações</button>
        </form>
    </main>
